...
public class Notification {
    ...
    @NotEmpty
    @Pattern(
            regexp = "WELCOME|BOOK_ADDED|BOOK_COMPLETED|SIMILAR_BOOKS|POST_ABOUT_CURRENT_BOOK|PROGRESS_REMINDER|CHALLENGE_ACCEPTED|CHALLENGE_PROGRESS|CHALLENGE_WINNER|GENERAL",
